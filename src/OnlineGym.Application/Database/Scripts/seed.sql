...
INSERT INTO administrators(account_id) VALUES (1);
...
VALUES
    (4,2,'Zdravo, želeo bih da zakažem prvi trening.',TRUE,'2026-07-02 10:00'),
    (2,4,'Naravno. Možemo da počnemo u petak u 18 časova.',TRUE,'2026-07-02 10:15'),
    (5,3,'Da li možemo da pomerimo sledeći trening na 19 časova?',FALSE,'2026-07-09 12:30'),
    (3,5,'Može, termin u 19 časova mi odgovara.',FALSE,'2026-07-09 12:45');

INSERT INTO registration_requests(trainer_id,administrator_id,request_date,status) VALUES
                                                                                       (1,1,'2026-06-20','APPROVED'),
                                                                                       (2,1,'2026-06-21','APPROVED');

INSERT INTO licenses(trainer_id,name,document_type,issue_date) VALUES
                                                                   (1,'Personalni trener','PDF','2024-01-15'),
                                                                   (2,'Fitnes instruktor','PDF','2023-10-01');

INSERT INTO pricing_packages(trainer_id,workouts_per_week,monthly_price) VALUES
                                                                             (1,3,12000),
                                                                             (1,5,18000),
                                                                             (2,3,11000),
                                                                             (2,5,17000);

INSERT INTO collaboration_requests(client_id,trainer_id,request_date,status) VALUES
...
INSERT INTO exercises(trainer_id,equipment_id,machine_id,name,video_url) VALUES
                                                                             (1,1,1,'Bench press',NULL),
                                                                             (1,2,2,'Čučanj',NULL),
                                                                             (1,2,NULL,'Mrtvo dizanje',NULL),
                                                                             (2,3,3,'Iskorak',NULL),
                                                                             (2,4,NULL,'Sklekovi',NULL);

INSERT INTO workouts(collaboration_id,scheduled_at,status,is_completed,comment,workout_rating) VALUES
                                                                                                   (1,'2026-07-10 18:00','COMPLETED',TRUE,'Odličan trening',5),
                                                                                                   (1,'2026-07-12 18:00','SCHEDULED',FALSE,NULL,NULL),
                                                                                                   (2,'2026-07-11 19:00','COMPLETED',TRUE,'Vidljiv napredak',4);
...
INSERT INTO ratings(client_id,trainer_id,rating,comment,rating_date) VALUES
                                                                         (1,1,5,'Odličan trener','2026-07-10'),
                                                                         (2,2,5,'Sve preporuke','2026-07-11'),
                                                                         (3,1,4,'Zadovoljan saradnjom','2026-07-08');

INSERT INTO memberships(collaboration_id,billing_month,payment_date,amount,is_paid) VALUES
...
VALUES
    ...
    (2,1,1,'Trener nije odgovarao na poruke.','2026-07-07','APPROVED','Administrator je upozorio trenera.');

INSERT INTO notifications(trainer_id,content,notification_date,type) VALUES
